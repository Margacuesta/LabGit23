...
public class ProductData {
    ...
    ProductData (String productId, String productName, int supplierId, String companyName, float unitPrice) { // este es el primer método que encontramos en la clase, se llama igual que la clase por lo que se llama CONSTRUCTOR (nombre de la clase= nombre del método)
        // el número de parámetros tiene que ser  distinto que el número de métodos, podemos tener tantos métodos como queramos.
	...
	ProductData (String productId, String productName, int supplierId, String companyName, float unitPrice, int a, int b) { // este es el primer método que encontramos en la clase, se llama igual que la clase por lo que se llama CONSTRUCTOR (nombre de la clase= nombre del método)
        // el número de parámetros tiene que ser  distinto que el número de métodos, podemos tener tantos métodos como queramos.
		this.productId    = productId;
        this.productName  = productName;
        this.supplierId   = supplierId;
	...
	// creamos un nuevo método al haber añadido dos variables más.
